...
import { ErrRespDataToFrontend, ErrRespFromBackend, JwtRespFromBackend, RegisterRequest, SuccessRespToFrontend } from '@/types.server';
...
export async function POST(request: NextRequest) {
  try {
    ...
    // Call backend service (server-side only)
