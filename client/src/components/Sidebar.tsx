...
import { ErrRespFromBackend } from '@/types.server';
...
const Sidebar: React.FC = () => {
  ...
  const sidebarStyle = {
    ...
    top: 0,
    zIndex: 999,
    borderRight: themeType === 'dark' ? '1px solid var(--primary-color)' : 'none'
  };
  ...
  return (
    <>
      ...
      >
        ...
        <div className="sidebar-top flex flex-column align-items-center pt-5" style={{ height: '80%' }}>
          ...
          <div className={`w-75 mb-5 ${themeType === 'dark' ? 'border-top-1 border-gray-800' : 'border-top-1 border-300'}`}></div>
        ...
        <div className="sidebar-bottom flex flex-column align-items-center pb-5" style={{ height: '20%' }}>
          <div className="menu-items flex flex-column gap-4">
            <IconButton 
