...
import { ErrRespFromBackend, RegisterRequest } from '@/types.server';
...
export default function RegisterForm() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (firstName && lastName && username && email && password && confirmPassword && password === confirmPassword) {
      setLoading(true);
      setError('');
  ...
  return (
    <form onSubmit={handleSubmit} className="p-fluid" action="/api/auth/register" method="POST">
