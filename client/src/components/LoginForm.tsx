...
import { ErrRespDataToFrontend } from '@/types.server';
    ...
    if (username && password) {
      ...
      try {
        ...
        if(response.ok){
            ...
            const errRespDataToClient = await response.json() as ErrRespDataToFrontend;
    ...
    <form onSubmit={handleSubmit} className="p-fluid">
      ...
      <div className="field-checkbox mb-4">
        <Checkbox
          inputId="rememberMe"
          checked={rememberMe}
          onChange={(e) => handleRememberMeChange(e.checked as boolean)}
        />
