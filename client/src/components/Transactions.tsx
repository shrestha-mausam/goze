                ...
                {transactions.map((transaction, index) => (
                    ...
                    >
                        <div className="flex justify-content-between align-items-center">
                            <div className="flex align-items-center">
                                <i
                                    className={`pi ${getCategoryIcon(transaction.category)} p-2 border-circle mr-3 ${transaction.amount >= 0 ? 'bg-green-100 text-green-500' : 'bg-blue-100 text-blue-500'}`}
                                ></i>
                                <div>
                            ...
                            <span
                                className={`font-medium ${transaction.amount >= 0 ? 'text-green-500' : 'text-blue-500'}`}
                            >
